...
class FileEncryptionApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # Tıklama ile dosya seçme işlevi
        self.drop_frame.mousePressEvent = self.select_file_on_click
    ...
    def select_file_on_click(self, event):
        self.select_file()
    ...
    def dragEnterEvent(self, event):
        """Sürüklenen öğe, dosya ise kabul edilir."""
