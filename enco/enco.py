...
def get_logo_path():
    ...
    # Sabit bir sistem yolu (ör. /usr/share/)
        ...
        return "/usr/share/icons/hicolor/256x256/apps/encolo.png"
    
    # Kullanıcı ev dizinindeki bir yol
    home_dir = os.path.expanduser("/home/fatih/.local/share/icons/hicolor/256x256/apps/encolo.png")
...
class FileEncryptionApp(QMainWindow):
    ...
    def show_about(self):
        about_text = (
            ...
            "Bu uygulama, dosyalarınızı güvenli bir şekilde Kilitleyip,çözmenizi sağlar.\n"
